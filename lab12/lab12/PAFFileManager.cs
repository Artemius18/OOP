...
namespace lab12
{
    internal class PAFFileManager
    {
        ...
        {
            CreateDirectory(@"D:\BSTU\2course\1term\OOP\lab12\lab12\PAFFiles");
            ...
            if (directoryInfo.Exists)
            {
                foreach (var file in directoryInfo.GetFiles())
                {
                    ...
                    {
                        file.CopyTo(@"D:\BSTU\2course\1term\OOP\lab12\lab12\PAFFiles\" + file.Name);
                    }
                }
            }
        }
        ...
        public static void FindInformationFromDay(int dayUser, int hour,int action)
        {
            ...
            using (var stream = new StreamReader(@"D:\BSTU\2course\1term\OOP\lab12\lab12\PAFlogfile.txt"))
            {
